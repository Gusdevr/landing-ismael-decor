...
import RoomPng from '../../assets/img/Galery/captura6.png'
...
const CortinaTrilho = () => {
  return (
    <ContainerUs>
        ...
        <h1>Cortina com Trilho</h1>
        <img src={RoomPng} alt="" />

        <h2>Adaptável e elegante</h2>
        <h3>Adicione um toque de elegância e funcionalidade ao seu espaço <br />
            com a nossa cortina com trilho. Esta peça de destaque combina <br />
            estilo sofisticado com praticidade moderna, permitindo um controle suave <br />
            e silencioso sobre a entrada de luz e privacidade. O trilho preciso <br />
            e discreto garante um deslizamento perfeito da cortina, criando uma <br />
            atmosfera envolvente em qualquer ambiente. Personalize sua escolha de <br />
            tecidos e padrões para criar uma cortina com trilho que se integre perfeitamente <br />
            ao seu estilo de decoração, ao mesmo tempo em que oferece um nível impecável <br />
            de conforto e controle de luz.</h3>
